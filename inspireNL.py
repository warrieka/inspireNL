...
from inspireNL_dialog import inspireNLDialog
import os.path
...
class inspireNL:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/inspireNL/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'INSPIRE NL'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&INSPIRE Nederland plugin voor QGIS'),
                action)
