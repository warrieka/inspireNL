...
class Ui_dataCatalogDlg(object):
    def setupUi(self, dataCatalogDlg):
        ...
        self.INSPIREannexLbl = QtWidgets.QLabel(self.filterWgt)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.INSPIREannexLbl.setObjectName("INSPIREannexLbl")
        self.gridLayout.addWidget(self.INSPIREannexLbl, 2, 0, 1, 1)
        self.INSPIREannexCbx = QtWidgets.QComboBox(self.filterWgt)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.INSPIREannexCbx.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.INSPIREannexCbx.setFrame(True)
        self.INSPIREannexCbx.setObjectName("INSPIREannexCbx")
    ...
    def retranslateUi(self, dataCatalogDlg):
        ...
        self.INSPIREannexLbl.setText(_translate("dataCatalogDlg", "INSPIRE-annex:"))
