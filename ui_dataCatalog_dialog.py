...
class Ui_dataCatalogDlg(object):
    def setupUi(self, dataCatalogDlg):
        ...
        dataCatalogDlg.setStatusTip("")
        dataCatalogDlg.setWhatsThis("")
        ...
        self.dlGMLchk = QtWidgets.QCheckBox(self.resultWgt)
        self.dlGMLchk.setObjectName("dlGMLchk")
        self.verticalLayout_2.addWidget(self.dlGMLchk)
